...
def test_parallel(num, image_id, run_core_base):
	for i in range(0, num):
		...
		docker_command = "docker run -it -v `pwd`:/root -w /home/yaowen/firmadyne --env USER=root --privileged zyw200/equafl_test sh -c \"python vul_run_aflfull.py %d %d %d \"" %(image_id, i, run_core_base)
