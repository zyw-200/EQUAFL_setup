...
cmdstr = "%s -c -A -S\"%s/analysis.py %s %s\" %s/%s" %(ida_source, script_dir, image_id, type_name, image_dir, prog_name)
# cmdstr = "%s -S\"%s/analysis.py %s %s\" %s/%s" %(ida_source, script_dir, image_id, type_name, image_dir, prog_name)
print cmdstr
os.system(cmdstr)
